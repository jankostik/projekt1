<?php
// source: /var/www/sites/projekt1/config/common.neon
// source: /var/www/sites/projekt1/config/local.neon
// source: array
...
class Container_25a18e8eda extends Nette\DI\Container
{
	protected $tags = [
		'nette.inject' => [
			'application.1' => true,
	...
	protected $wiring = [
		...
		'ArrayAccess' => [2 => ['05', 'application.2', 'application.3', 'application.4', 'application.5']],
		'Countable' => [2 => ['05']],
		...
		'App\Presenters\BasePresenter' => [2 => ['application.2', 'application.3', 'application.4', 'application.5']],
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => '/var/www/sites/projekt1/app',
			'wwwDir' => '/var/www/sites/projekt1/www',
			'vendorDir' => '/var/www/sites/projekt1/vendor',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => '/var/www/sites/projekt1/temp',
		];
	}
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/var/www/sites/projekt1/temp/cache/nette.application/touch'
		));
	...
	{
		return new Nette\Caching\Storages\FileStorage('/var/www/sites/projekt1/temp/cache');
	}


	public function createServiceContainer(): Container_25a18e8eda
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_25a18e8eda $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/var/www/sites/projekt1/temp/cache/latte');
