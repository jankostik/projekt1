...
class Container_eb64641d53 extends Nette\DI\Container
{
	protected $tags = [
		'nette.inject' => [
			'08' => true,
	...
	public function createServiceContainer(): Container_eb64641d53
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_eb64641d53 $container)
			{
